...
let displayTeams = (json) => {
    for (const trainer of json) {
        ...
        button.addEventListener('click', (e)=>{
            // get trainer id
            // search for free pokemon
            // add pokemon to team/trainer
            // send patch to trainer
        });
        ...
        for (const p of pokemons) {
            ...
            release.addEventListener('click', (e)=>{
                // set pokemon free
                // remove trainer id from target pokemon
                // send patch request to pokemon
            })
